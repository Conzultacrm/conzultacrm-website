    ...
    <div className="pt-16">
      ...
      <section className="py-10 bg-neutral-50 border-t border-neutral-100">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="section-label text-neutral-400 mb-2">Inversión</p>
          <h2
          ...
          <p className="text-neutral-500 text-base max-w-xl mx-auto mb-4">
          ...
          <Link
            href="/contacto"
            className="text-[#004AC6] font-semibold text-sm hover:underline inline-flex items-center gap-1"
            style={{ fontFamily: "var(--font-syne)" }}
          >
